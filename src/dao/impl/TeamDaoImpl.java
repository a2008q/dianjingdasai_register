...
public class TeamDaoImpl implements TeamsDao {
    ...
    public int TeamRegDao(Teams t) {
        ...
        try {
            ...
            //获取连接
            conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/reg?serverTimezone =UTC", "reg", "yhh515515");
            //创建sql命令
            String sql = "INSERT INTO teaminfo(name, captain, member1, member2, member3, member4,phone) value(?,?,?,?,?,?,?)";
            //创建sql命令对象
