...
<div class="box-1">
  <div class="box-2">
    ...
    <form action="RegServlet" method="post">
      <h4 style="float: left;margin-left: 90px;">战队名:</h4><input type="text" name="name" placeholder="请输入战队名" style="float: left;margin-top: 19px;padding: 5px;border: none;border-bottom: 2px solid rgb(19, 18, 18);">
      ...
      <input type="submit" style="margin-top: 400px;border:0;background-color: aqua;vertical-align:middle;width: 80px;height: 30px;font-family: 楷体;">
    </form>
  </div>
</div>
</body>
